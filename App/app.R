...
ui <- navbarPage(
  ...
  tabPanel("Home",
           fluidPage(
                 tags$div(class = "custom-header",
                          ...
                          h3("An exploration of trends in restaurant health code violations across New York City"),
                 ...
                 tags$div(class = "custom-container",
                          ...
                          tags$div(class = "custom-text",
                                  ...
                                  p("Within this website, you will find maps, barplots, and line plots that demonstrate trends in the number of violations across NYC and between boroughs, cuisines, types of violations, and the customer experience and how these factors relate to socioeconomic makeups of the neighborhoods."))),
                 tags$div(class = "custom-container",
                          ...
                          tags$div(class = "custom-row",
                                   ...
                                   tags$div(class = "col-md-4 feature",
                                            ...
                                            h3("Critical Violations"),
                                            h4("Look closer at the most critical and common health code violations.")
                                   ),
                                   tags$div(class = "col-md-4 feature",
  ...
  tabPanel('Overall Trends',
           fluidPage(
             tags$div(class = "custom-container",
                      ...
                      tags$div(class = "custom-text",
                               p("The section breaks down the overall trends of health code violations across New York City and within each borough and how other factors, like socioeconomic status are related."))
             ),
  ...
  tabPanel('Critical Violations',
           fluidPage(
              tags$div(class = "custom-container",
                       h2("Trends in Critical Health Code Violations"),
                       tags$div(class = "custom-text",
                                p("This page dives deeper into a range of different types of violations, more specifically, the top 10 most common critical violations across New York City."))
                 ),
              tags$div(class = 'custom-container',
                       h3("Maps of Top 10 Most Common Critical Violations Across NYC"),
                       tags$div(class = "custom-text",
                                p("The following maps allow you to explore restaurants who have been issued violations of the following health code violations:")),
