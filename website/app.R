...
source("~/Desktop/website/map_functions.R")
source("~/Desktop/website/line_functions.R")
source("~/Desktop/website/BarGraphs.R")
source("~/Desktop/website/text_functions.R")
...
server <- function(input, output) {
  ...
  hcv <- read.csv("~/Desktop/website/data/hcvyear.csv")
  nyczips <- read.csv("~/Desktop/website/data/nyc-zip-codes.csv")
  dta <- read.csv("~/Desktop/website/data/22zpallagi.csv")
  queens_revs <-  read.csv("~/Desktop/website/data/queens_revs.csv")
  bronx_revs <- read.csv("~/Desktop/website/data/bronx_revs.csv")
  man_revs <- read.csv("~/Desktop/website/data/man_revs.csv")
  brook_revs <- read.csv("~/Desktop/website/data/brook_revs.csv")
  stat_revs <- read.csv("~/Desktop/website/data/stat_revs.csv")
